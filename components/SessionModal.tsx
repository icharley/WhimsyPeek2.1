      ...
      <div className="bg-white rounded-xl max-w-2xl w-full max-h-[90vh] overflow-hidden">
        <div className="flex justify-between items-center p-6 border-b">
          <h2 className="text-2xl font-bold text-gray-900">
            {session ? "Edit PeekList" : "Create New PeekList"}
          </h2>
          <button
            onClick={onClose}
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <textarea
                ...
                rows={3}
                placeholder="Brief description of this PeekList... what is it about? are there rules? etc."
              />
            </div>
            ...
            <div>
              <div className="flex justify-between items-center mb-3">
                <label className="block text-sm font-medium text-gray-700">
                  Add your choices and let whimsy decide!
                </label>
                <button
                  type="button"
              ...
              <p className="text-xs text-gray-500 mt-2">
                Add as many choices as you want. Empty choice boxes will be
